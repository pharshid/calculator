 ...
 */
public class ERVExpandableDataProvider extends AbstractExpandableDataProvider {
    ...
    public ERVExpandableDataProvider(List<Item> _mItems) {
        ...
        for (int i = 0; i < _mItems.size(); i++) {
            ...
            final Item groupItem = _mItems.get(i);
            ...
            final ConcreteGroupData group = new ConcreteGroupData(groupId, groupItem, groupSwipeReaction);
...
//            }
    ...
    public ERVExpandableDataProvider() { mData = new LinkedList<>(); }

    public void add(Item item) {
        final int groupSwipeReaction = RecyclerViewSwipeManager.REACTION_CAN_SWIPE_LEFT | RecyclerViewSwipeManager.REACTION_CAN_SWIPE_RIGHT;
        final ConcreteGroupData group = new ConcreteGroupData(mData.size(), item, groupSwipeReaction);
        final List<ChildData> children = new ArrayList<>();
        final long childId = group.generateNewChildId();
        final String childText = "TEST";
        final int childSwipeReaction = RecyclerViewSwipeManager.REACTION_CAN_SWIPE_LEFT | RecyclerViewSwipeManager.REACTION_CAN_SWIPE_RIGHT;
    ...
    public static final class ConcreteGroupData extends GroupData {
        ...
        ConcreteGroupData(long id, Item item, int swipeReaction) {
            mId = id;
            mItem = item;
